...
class TableauLesson10 extends StatefulWidget {
  const TableauLesson10({super.key});

  @override
  State<TableauLesson10> createState() => _TableauLesson10State();
}

class _TableauLesson10State extends State<TableauLesson10> {
  ...
  void loadStatus() async {
    ...
    setState(() {
      isCompleted = prefs.getBool("Lesson 10 — Dashboards") ?? false;
    });
  }

  Future<void> markCompleted() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool("Lesson 10 — Dashboards", true);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Lesson 10 — Dashboards")),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            component("KPIs (Top)", "Revenue, Visits, Avg Length of Stay"),
            component(
              "Patient Demographics",
              "Gender and marital status distribution",
            ),
            component("Department Revenue", "Revenue by department and month"),
            component("Map", "Geographic healthcare utilization"),
            component("Revenue Trend", "Monthly revenue line chart"),
            component("Provider Performance", "Doctor/specialty comparison"),
            component("Filters", "Department and Year selection"),
