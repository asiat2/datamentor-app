...
class TableauLesson12 extends StatefulWidget {
  const TableauLesson12({super.key});

  @override
  State<TableauLesson12> createState() => _TableauLesson12State();
}

class _TableauLesson12State extends State<TableauLesson12> {
  ...
  void loadStatus() async {
    ...
    setState(() {
      isCompleted = prefs.getBool("Lesson 12 — Best Practices") ?? false;
    });
  }

  Future<void> markCompleted() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool("Lesson 12 — Best Practices", true);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Lesson 12 — Best Practices"),
        centerTitle: true,
      ),
