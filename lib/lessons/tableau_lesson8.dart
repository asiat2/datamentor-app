...
class TableauLesson8 extends StatefulWidget {
  const TableauLesson8({super.key});

  @override
  State<TableauLesson8> createState() => _TableauLesson8State();
}

class _TableauLesson8State extends State<TableauLesson8> {
  ...
  void loadStatus() async {
    ...
    setState(() {
      isCompleted = prefs.getBool("Lesson 8 — Parameters") ?? false;
    });
  }

  Future<void> markCompleted() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool("Lesson 8 — Parameters", true);
