...
class PythonLesson2 extends StatefulWidget {
  const PythonLesson2({super.key});

  @override
  State<PythonLesson2> createState() => _PythonLesson2State();
}

class _PythonLesson2State extends State<PythonLesson2> {
  ...
  void loadStatus() async {
    ...
    setState(() {
      isCompleted = prefs.getBool("Lesson 2 — Variables & Data Types") ?? false;
    });
  }

  Future<void> markCompleted() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool("Lesson 2 — Variables & Data Types", true);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Lesson 2 — Variables & Data Types")),
