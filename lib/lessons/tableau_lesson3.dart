...
class TableauLesson3 extends StatefulWidget {
  const TableauLesson3({super.key});

  @override
  State<TableauLesson3> createState() => _TableauLesson3State();
}

class _TableauLesson3State extends State<TableauLesson3> {
  ...
  void loadStatus() async {
    ...
    setState(() {
      isCompleted = prefs.getBool("Lesson 3 — Tableau Interface") ?? false;
    });
  }

  Future<void> markCompleted() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool("Lesson 3 — Tableau Interface", true);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset(
              'assets/images/tableau_interface.png', // add your image
              fit: BoxFit.contain,
            ),
