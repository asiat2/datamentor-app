...
class PowerBILesson9 extends StatefulWidget {
  const PowerBILesson9({super.key});

  @override
  State<PowerBILesson9> createState() => _PowerBILesson9State();
}

class _PowerBILesson9State extends State<PowerBILesson9> {
  ...
  void loadStatus() async {
    ...
    setState(() {
      isCompleted =
          prefs.getBool("Lesson 9 — Measures and Calculations") ?? false;
    });
  }

  Future<void> markCompleted() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool("Lesson 9 — Measures and Calculations", true);
