...
class PowerBILesson10 extends StatefulWidget {
  const PowerBILesson10({super.key});

  @override
  State<PowerBILesson10> createState() => _PowerBILesson10State();
}

class _PowerBILesson10State extends State<PowerBILesson10> {
  ...
  void loadStatus() async {
    ...
    setState(() {
      isCompleted = prefs.getBool("Lesson 10 — Publishing Reports") ?? false;
    });
  }

  Future<void> markCompleted() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool("Lesson 10 — Publishing Reports", true);
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            step("Share Link", "Send a link so others can view your report."),

            step("Permissions", "Control who can view or edit the report."),

            step("Apps", "Publish dashboards as apps for wider distribution."),

            // REAL EXAMPLES
            sectionTitle("Real-Life Examples"),

            explanation("Business Example:"),

            infoBox(
              "A company publishes a sales dashboard so managers can track revenue daily.",
            ),

            explanation("Healthcare Example:"),
