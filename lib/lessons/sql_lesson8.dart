...
class SqlLesson8 extends StatefulWidget {
  const SqlLesson8({super.key});

  @override
  State<SqlLesson8> createState() => _SqlLesson8State();
}

class _SqlLesson8State extends State<SqlLesson8> {
  ...
  void loadStatus() async {
    ...
    setState(() {
      isCompleted = prefs.getBool("Lesson 8 — SQL JOIN Types") ?? false;
    });
  }

  Future<void> markCompleted() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.setBool("Lesson 8 — SQL JOIN Types", true);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Lesson 8 — SQL JOIN Types")),
          ...
          children: [
            ...
            DataTable(
              ...
              rows: const [
                ...
                DataRow(cells: [DataCell(Text("2")), DataCell(Text("Mary"))]),
                DataRow(cells: [DataCell(Text("3")), DataCell(Text("David"))]),
              ],
            ),
