...
class PowerBILesson7 extends StatelessWidget {
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Lesson 7 — Power BI Data Model"),
      ),
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            explanation(
              "A sales analysis dataset might include these tables:"
            ),
            ...
            explanation(
              "The relationship is created using CustomerID."
            ),
            ...
            explanation(
              "Filtering flows from one table to another."
            ),
            ...
            explanation(
              "Filtering flows between both tables."
            ),
            ...
            exampleBox(
              "Good Data Model → Faster Reports + Accurate Insights"
            ),
